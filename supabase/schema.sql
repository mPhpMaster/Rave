...
-- ============================================================
-- friendships
-- Stored once per pair; convention: user_a < user_b.
-- ============================================================
...
-- ============================================================
-- join_via_invite RPC
-- Lets a logged-in user join a room by its invite_code without
-- needing direct SELECT on rooms (which is gated by membership).
-- security definer so it can SELECT past RLS; auth.uid() still
-- reflects the calling user since it reads from JWT claims.
-- ============================================================
...
-- ============================================================
-- Storage: room-videos bucket for MP4 uploads
-- ============================================================
...
-- No SELECT policy: the bucket stays private. The Socket.IO server mints
-- short-lived signed URLs (service-role) and embeds them in room:snapshot.
